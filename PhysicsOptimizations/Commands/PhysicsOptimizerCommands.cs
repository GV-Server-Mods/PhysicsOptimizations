...
namespace PhysicsOptimizer.Commands
{
    ...
    public class PhysicsOptimizerCommands : CommandModule
    {
        ...
        public void Status()
        {
            ...
            sb.AppendLine(string.Format(CultureInfo.InvariantCulture, "  - Push-Apart: {0} (Base: {1:F2}m, Max: {2:F2}m, Threshold: {3} frames, Max Attempts: {4}, Station On Give-Up: {5}, Debug GPS: {6}, Min Impact: {7:F1} m/s, Exclude Wheels: {8}, Embed Depth: {9:F2}m)", cfg.EnablePushApart, cfg.PushApartDistance, cfg.PushApartMaxNudgeDistance, cfg.PushApartThreshold, cfg.PushApartMaxAttempts, cfg.ConvertToStaticOnPushApartGiveUp, cfg.EnablePushApartDebugDraw, cfg.PushApartMinImpactSpeed, cfg.ExcludeWheelSubgridsFromPushApart, cfg.PushApartEmbeddedDepth));
